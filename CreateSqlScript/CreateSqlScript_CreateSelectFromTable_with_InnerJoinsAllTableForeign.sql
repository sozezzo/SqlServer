...
*/
CREATE OR ALTER PROCEDURE #CreateSqlScript_CreateSelectFromTable_with_InnerJoinsAllTableForeign
(
...
BEGIN
	...
	DECLARE @crlf          AS nvarchar(10)   = CHAR(10);
	...
	WITH AllColumns
		 ...
		 SELECT 
				@tsql = 
			   N'SELECT TOP(1000) ' + QUOTENAME(@tableName) + N'.*' + @crlf +
